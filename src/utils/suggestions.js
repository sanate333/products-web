...
export const suggestHighlights = (productName, category = '') => {
...
export const suggestFAQs = (productName, category = '') => {
  const name = safe(productName) || 'este producto';
  const hint = categoryHint(category);
  return [
...
export const suggestComparisonRows = (productName, category = '') => {
...
export const suggestTestimonialsText = (productName, category = '') => {
...
export const suggestBannersCopy = (productName, category = '') => {
