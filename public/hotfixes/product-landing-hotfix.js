...
function startBounce(container){
  ...
  var sz=58; // approx element size in px (52px font + padding)
  var states=[];
...
// Run popup hide immediately and after delays (popup appears after a few seconds)
setTimeout(hidePopup,500);
setTimeout(hidePopup,2000);
setTimeout(hidePopup,4000);
// Also observe DOM changes to catch popup when it appears
